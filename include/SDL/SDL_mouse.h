 ...
 */
typedef Uint8 SDLCALL tSDL_GetMouseState(int *x, int *y);
 ...
 */
typedef Uint8 SDLCALL tSDL_GetRelativeMouseState(int *x, int *y);

/**
 * Set the position of the mouse cursor (generates a mouse motion event)
 */
typedef void SDLCALL tSDL_WarpMouse(Uint16 x, Uint16 y);
