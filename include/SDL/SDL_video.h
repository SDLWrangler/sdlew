 ...
 */
typedef int SDLCALL tSDL_VideoInit(const char *driver_name, Uint32 flags);
 ...
 * SDL_SetVideoMode()
 */
typedef int SDLCALL tSDL_VideoModeOK(int width, int height, int bpp, Uint32 flags);
 ...
 */
typedef void SDLCALL tSDL_UpdateRects
		(SDL_Surface *screen, int numrects, SDL_Rect *rects);
/**
 * If 'x', 'y', 'w' and 'h' are all 0, SDL_UpdateRect will update the entire
 * screen.
 */
typedef void SDLCALL tSDL_UpdateRect
 ...
 */
typedef int SDLCALL tSDL_Flip(SDL_Surface *screen);
 ...
 */
typedef int SDLCALL tSDL_SetGamma(float red, float green, float blue);
 ...
 */
typedef int SDLCALL tSDL_SetGammaRamp(const Uint16 *red, const Uint16 *green, const Uint16 *blue);
 ...
 * this function will return -1.
 */
typedef int SDLCALL tSDL_GetGammaRamp(Uint16 *red, Uint16 *green, Uint16 *blue);
 ...
 * emulation.
 */
typedef int SDLCALL tSDL_SetColors(SDL_Surface *surface, 
 ...
 */
typedef int SDLCALL tSDL_SetPalette(SDL_Surface *surface, int flags,
 ...
 */
typedef Uint32 SDLCALL tSDL_MapRGB
 ...
 */
typedef Uint32 SDLCALL tSDL_MapRGBA
(const SDL_PixelFormat * const format,
 ...
 */
typedef int SDLCALL tSDL_SetColorKey
 ...
 */
typedef int SDLCALL tSDL_SetAlpha(SDL_Surface *surface, Uint32 flag, Uint8 alpha);
 ...
 */
typedef SDL_bool SDLCALL tSDL_SetClipRect(SDL_Surface *surface, const SDL_Rect *rect);
 ...
 */
typedef void SDLCALL tSDL_GetClipRect(SDL_Surface *surface, SDL_Rect *rect);
...
typedef int SDLCALL tSDL_LockYUVOverlay(SDL_Overlay *overlay);
typedef void SDLCALL tSDL_UnlockYUVOverlay(SDL_Overlay *overlay);
 ...
 */
typedef int SDLCALL tSDL_DisplayYUVOverlay(SDL_Overlay *overlay, SDL_Rect *dstrect);

/** Free a video overlay */
typedef void SDLCALL tSDL_FreeYUVOverlay(SDL_Overlay *overlay);
 ...
 */
typedef void SDLCALL tSDL_GL_SwapBuffers(void);
 ...
 */
/*@{*/
typedef void SDLCALL tSDL_GL_UpdateRects(int numrects, SDL_Rect* rects);
typedef void SDLCALL tSDL_GL_Lock(void);
typedef void SDLCALL tSDL_GL_Unlock(void);
/*@}*/
 ...
 */
typedef void SDLCALL tSDL_WM_SetCaption(const char *title, const char *icon);
/**
 * Gets the title and icon text of the display window (UTF-8 encoded)
 */
typedef void SDLCALL tSDL_WM_GetCaption(char **title, char **icon);
 ...
 */
typedef void SDLCALL tSDL_WM_SetIcon(SDL_Surface *icon, Uint8 *mask);
 ...
 */
typedef int SDLCALL tSDL_WM_IconifyWindow(void);
 ...
 */
typedef int SDLCALL tSDL_WM_ToggleFullScreen(SDL_Surface *surface);
 ...
 */
typedef SDL_GrabMode SDLCALL tSDL_WM_GrabInput(SDL_GrabMode mode);
