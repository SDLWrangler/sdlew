 ...
 * @sa SDL_AudioSpec
 */
typedef int SDLCALL tSDL_OpenAudio(SDL_AudioSpec *desired, SDL_AudioSpec *obtained);
 ...
 */
typedef void SDLCALL tSDL_MixAudio(Uint8 *dst, const Uint8 *src, Uint32 len, int volume);
