...
typedef void SDLCALL tSDL_SetModuleHandle(void *hInst);
/** This can also be called, but is no longer necessary */
typedef int SDLCALL tSDL_RegisterApp(char *name, Uint32 style, void *hInst);
...
typedef void SDLCALL tSDL_InitQuickDraw(struct QDGlobals *the_qd);
