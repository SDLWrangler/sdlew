 ...
 */
typedef int SDLCALL tSDL_CDNumDrives(void);
 ...
 */
typedef CDstatus SDLCALL tSDL_CDStatus(SDL_CD *cdrom);
 ...
 */
typedef int SDLCALL tSDL_CDPlayTracks(SDL_CD *cdrom,
 ...
 */
typedef int SDLCALL tSDL_CDPlay(SDL_CD *cdrom, int start, int length);

/** Pause play
 *  @return returns 0, or -1 on error
 */
typedef int SDLCALL tSDL_CDPause(SDL_CD *cdrom);

/** Resume play
 *  @return returns 0, or -1 on error
 */
typedef int SDLCALL tSDL_CDResume(SDL_CD *cdrom);

/** Stop play
 *  @return returns 0, or -1 on error
 */
typedef int SDLCALL tSDL_CDStop(SDL_CD *cdrom);

/** Eject CD-ROM
 *  @return returns 0, or -1 on error
 */
typedef int SDLCALL tSDL_CDEject(SDL_CD *cdrom);
