...
/*@{*/
typedef int SDLCALL tSDL_WriteLE16(SDL_RWops *dst, Uint16 value);
typedef int SDLCALL tSDL_WriteBE16(SDL_RWops *dst, Uint16 value);
typedef int SDLCALL tSDL_WriteLE32(SDL_RWops *dst, Uint32 value);
typedef int SDLCALL tSDL_WriteBE32(SDL_RWops *dst, Uint32 value);
typedef int SDLCALL tSDL_WriteLE64(SDL_RWops *dst, Uint64 value);
