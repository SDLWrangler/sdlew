 ...
 */
typedef int SDLCALL tSDL_JoystickOpened(int device_index);

/**
 * Get the device index of an opened joystick.
 */
typedef int SDLCALL tSDL_JoystickIndex(SDL_Joystick *joystick);
 ...
 */
typedef Sint16 SDLCALL tSDL_JoystickGetAxis(SDL_Joystick *joystick, int axis);
 ...
 */
typedef Uint8 SDLCALL tSDL_JoystickGetHat(SDL_Joystick *joystick, int hat);
 ...
 */
typedef int SDLCALL tSDL_JoystickGetBall(SDL_Joystick *joystick, int ball, int *dx, int *dy);
 ...
 */
typedef Uint8 SDLCALL tSDL_JoystickGetButton(SDL_Joystick *joystick, int button);
